...
from pycaliper.verif.jgverifier import JGDesign, Design
from pycaliper.synth.btorsynthesizer import BTORVerifier2TraceIncremental
from pycaliper.verif.btorverifier import BTORDesign, DesignConfig
...
class HoudiniSynthesizerBTOR(HoudiniSynthesizer):
    ...
    def _setup_synthesis(self):
        assert isinstance(self.des, BTORDesign), "Design not of type JGDesign."
        self.candidates = {
